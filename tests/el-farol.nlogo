# SYNTAX TEST "source.nlogo" "el-farol.nlogo"

; Extracted from NetLogo Model Library v6.4.0
# <- comment.line.semicolon.netlogo
; See the Info tab for copyright and license information.
# <- comment.line.semicolon.netlogo

globals [
#       ^ meta.brackets.netlogo
# ^^^^ storage.modifier.global.netlogo
...
to setup
#^ storage.type.class.netlogo
#  ^^^^^ entity.name.type.class.netlogo
  clear-all
# ^^^^^^^^^ support.function.builtin.netlogo
  set-default-shape turtles "person"
# ^^^^^^^^^^^^^^^^^ support.function.builtin.netlogo
#                   ^^^^^^^ keyword.other.netlogo
#                           ^^^^^^^^ string.quoted.double.netlogo
...
#                               ^ meta.brackets.netlogo
#                                ^^^^^ keyword.other.netlogo
#                                      ^ keyword.operator.comparison.netlogo
#                                        ^ constant.numeric.integer.netlogo
#                                          ^^ keyword.operator.logical.netlogo
#                                             ^ meta.parens.netlogo
#                                              ^^^^ keyword.other.netlogo
#                                                    ^ keyword.operator.comparison.netlogo
#                                                        ^^^ keyword.operator.logical.netlogo
...
#                    ^^^ support.function.builtin.netlogo
#                        ^^^^^ keyword.other.netlogo
#                               ^^^^^ constant.language.color.netlogo
#                                     ^ meta.brackets.netlogo
...
#           ^^^^^^^^ keyword.other.netlogo
#                    ^ meta.parens.netlogo
#                                 ^ keyword.operator.arithmetic.netlogo
#                                   ^ constant.numeric.integer.netlogo
#                                    ^ meta.parens.netlogo
#                                      ^ meta.brackets.netlogo
#                                        ^^^^^ keyword.other.netlogo
...
#^^ keyword.control.statement.netlogo
...
#             ^ meta.brackets.netlogo
    ifelse attend?
#   ^^^^^^ keyword.control.conditional.netlogo
...
# ^^^^^^^ keyword.control.loop.for.netlogo
#                    ^ meta.brackets.netlogo
#                                   ^^ keyword.operator.assignment.netlogo
    let score 0
#   ^^^ support.function.builtin.netlogo
#             ^ constant.numeric.integer.netlogo
    let week 1
...
#            ^ constant.numeric.integer.netlogo
    repeat memory-size [
#   ^^^^^^ keyword.control.repeat.netlogo
...
# ^^^^^ keyword.control.loop.while.netlogo
#       ^ meta.brackets.netlogo
#        ^^^^ keyword.other.netlogo
#             ^^^^^ keyword.other.netlogo
#                   ^^^^^^^^^^^^ keyword.other.netlogo
